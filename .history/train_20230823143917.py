...
def get_parserargs():
    ...
    parser.add_argument('--is_use_checkpoint', '-iuc', metavar='iUC', default=False, help='use checkpoint or not')
    ...
    parser.add_argument('--aug_contrast', '-ac', metavar='AC', type=float, help='contrast of color jitter')
     ...
     # Multi-crop setting
    parser.add_argument('--aug_global_crops_scale', '-agcs', type=float, nargs='+', default=(0.4, 1.), help="""Scale range of the cropped image before resizing, 
    ...
    parser.add_argument('--aug_local_crops_number', '-alcn', type=int, default=8, help="""Number of small local views to generate. Set this parameter to 0 to disable
                         multi-crop training. When disabling multi-crop we recommend to use "--global_crops_scale 0.14 1." """)
    parser.add_argument('--aug_local_crops_scale', 'alcs', type=float, nargs='+', default=(0.05, 0.4), help="""Scale range of the cropped image before resizing, 
    ...
    # (dino)
    parser.add_argument('--is_norm_last_layer', default=True, help="""Not normalizing leads to better performance but can make the training unstable. 
