...
def get_parserargs():
    ...
    parser.add_argument('--wds_is_restart', '-wdsir', metavar='WDSIR', default=False, help='is restart of cosinewarm scheduler')
    ...
    # final_momentum_teacher, is_restart
    parser.add_argument('--final_momentum_teacher', '-fmt', metavar='FMT', type=float, default=1., help='Final value for the teacher momentum.')
    parser.add_argument('--is_restart_teacher', '-irt', metavar='IRT', default=True, help='Whether to restart the teacher momentum scheduler.')
    ...
    # max_value, min_value, total_iters, warmup_iters=0, start_warmup_value=0, freeze_iters=0, is_restart=False, T_0=5, T_mult=2
    ...
    parser.add_argument('--freeze_last_layer_epochs', default=1, type=int, help="""Number of epochs
