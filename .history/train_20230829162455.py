...
def train(cfg, frame, train_dataset):
    ...
    for epoch in range(cfg.TRAIN.START_EPOCH, cfg.TRAIN.NUM_EPOCHS):
        ...
        if epoch == cfg.TRAIN.START_EPOCH:
            ...
            frame.save_weights(cfg.DATA.TRAIN_DATA_PATH, cfg.NET.NAME, cfg.CFG_NOTE, epoch, train_epoch_loss)
        else:
...
def get_parserargs():
    ...
    # output dir
    parser.add_argument('--output_path', '-op', type=str, help='output dir')
