...
class DinoV1(nn.Module):
    def __init__(self, cfg):
        ...
        self.student_head = DINOHead(cfg.NET.EMBED_DIM, cfg.NET.OUT_DIM, use_bn=args.use_bn_in_head, norm_last_layer=args.norm_last_layer)
        self.teacher_head = DINOHead(cfg.NET.EMBED_DIM, cfg.NET.OUT_DIM, args.use_bn_in_head)
