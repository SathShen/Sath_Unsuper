...
class PretrainFrame():
    def __init__(self, cfgs):
        ...
        self.wd_scheduler = CosineScheduler(cfgs, self.optimizer, self.last_epoch)
        self.momentum_scheduler = CosineScheduler(cfgs, self.last_epoch)
        self.teacher_temp_scheduler = CosineScheduler(cfgs, self.last_epoch)
