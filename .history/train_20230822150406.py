...
def get_parserargs():
    ...
    parser.add_argument('--weight_decay', '-wd', metavar='WD', type=float, help='start lambda of weight decay')
    parser.add_argument('--lrs_final_value', '-wdsfv', metavar='WDSMV', type=float, help='final value of cosinewarm scheduler(max in cycle)')
    parser.add_argument('--lrs_is_restart', '-lrsir', metavar='LRSIR', default=True, help='is restart of cosinewarm scheduler')
