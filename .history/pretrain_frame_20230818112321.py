...
class PretrainFrame():
    ...
    def save_weights(self, train_data_path, net_name, cfg_note, epoch, loss):
        """save checkpoint with loss NOT mIoU
        Args:
            train_data_path (_type_): _description_
            net_name (_type_): _description_
            cfg_note (_type_): _description_
            epoch (_type_): _description_
            best_mIoU (_type_): _description_
