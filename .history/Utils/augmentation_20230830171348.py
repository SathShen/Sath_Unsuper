...
class DinoV1Augmentation(object):
    def __init__(self, cfgs):
        ...
        self.global_transfo1 = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomResizedCrop(cfgs.AUG.CROP_SIZE, scale=cfgs.AUG.GLOBAL_SCALE, interpolation=intermode.BICUBIC),
            flips,
            color_jitter,
        ...
        self.local_transfo = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomResizedCrop(cfgs.AUG.LOCAL_CROP_SIZE, scale=cfgs.AUG.LOCAL_SCALE, interpolation=intermode.BICUBIC),
            flips,
            color_jitter,
