...
from torchvision.transforms import InterpolationMode as intermode
...
class DinoV1Augmentation(object):
    def __init__(self, cfgs):
        ...
        self.local_transfo = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomResizedCrop(cfgs.AUG.LOCAL_CROP_SIZE, scale=cfgs.AUG.LOCAL_SCALE, interpolation=InterpolationMode.BICUBIC),
            flips,
            color_jitter,
