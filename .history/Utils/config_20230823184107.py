...
def update_config(config, args):
    ...
    if _check_args('num_iters_per_epoch'):
        config.NUM_ITERS_PER_EPOCH = args.num_iters_per_epoch
    ...
    if _check_args('aug_global_scale'):
        config.AUG.GLOBAL_SCALE = tuple(args.aug_global_scale)
    if _check_args('aug_local_number'):
        config.AUG.LOCAL_NUMBER = args.aug_local_number
    if _check_args('aug_local_scale'):
        config.AUG.LOCAL_SCALE = tuple(args.aug_local_scale)
