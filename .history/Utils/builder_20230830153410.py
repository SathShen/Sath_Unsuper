...
def build_loss(cfg):
    if cfg.TRAIN.LOSS.NAME == 'dinov1':
        loss_func = DinoV1Loss(out_dim=cfg.NET.OUT_DIM,
                               ...
                               warmup_teacher_temp=cfg.TRAIN.LOSS.WARMUP_TEACHER_TEMP,
                               teacher_temp=cfg.TRAIN.LOSS.TEACHER_TEMP,
                               warmup_teacher_temp_epochs=cfg.TRAIN.LOSS.WARMUP_TEACHER_TEMP_EPOCHS,
                               nepochs=cfg.TRAIN.LOSS.NEPOCHS,
                               student_temp=cfg.TRAIN.LOSS.STUDENT_TEMP,
                               center_momentum=cfg.TRAIN.LOSS.CENTER_MOMENTUM)
