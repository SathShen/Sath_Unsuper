...
base_cfg.LEARNING_RATE = 2e-3
# LR scheduler
base_cfg.LR_SCHEDULER = CN()
base_cfg.LR_SCHEDULER.NAME = 'cosine'
# Epoch interval to decay LR, used in StepLRScheduler
base_cfg.LR_SCHEDULER.DECAY_EPOCHS = 30
# LR decay rate, used in StepLRScheduler
base_cfg.LR_SCHEDULER.DECAY_RATE = 0.5
# warmup_prefix used in CosineLRScheduler
base_cfg.LR_SCHEDULER.T_MAX = 30
base_cfg.LR_SCHEDULER.T_MULT = 2
base_cfg.LR_SCHEDULER.ETA_MIN = 2e-5
