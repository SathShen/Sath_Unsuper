...
class DinoV1Augmentation(object):
    def __init__(self, cfg):
        ...
        self.global_transfo1 = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomResizedCrop(cfg.AUG.CROP_SIZE, scale=cfg.AUG.GLOBAL_SCALE, interpolation=intermode.BICUBIC),
            flips,
            color_jitter,
        ...
        self.local_transfo = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomResizedCrop(cfg.AUG.LOCAL_CROP_SIZE, scale=cfg.AUG.LOCAL_SCALE, interpolation=intermode.BICUBIC),
            flips,
            color_jitter,
