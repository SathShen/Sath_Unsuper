...
def train(cfg, frame, train_dataset):
    ...
    # print device info
    logger.info(f'rank: {dist.get_rank()}, world_size: {dist.get_world_size()}, local_rank: {cfg.LOCAL_RANK}')
...
def get_parserargs():
    ...
    # train setting
    parser.add_argument('--num_nodes', '-nn', metavar='N', type=int, default=1, help='number of nodes for training')
