...
def get_parserargs():
    ...
    parser.add_argument('--aug_local_number', '-aln', type=int, default=8, help="""Number of small local views to generate. Set this parameter to 0 to disable
    ...
    parser.add_argument('--net_swinv2unet_is_qkv_bias', '-nsuiqb', metavar='NSUQKB', help='qkv bias of swin')
    parser.add_argument('--net_swinv2unet_is_ape', '-nsuap', metavar='NSUAP', type=bool, help='ape of swin')
