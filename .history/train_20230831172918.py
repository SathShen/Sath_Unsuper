...
def get_parserargs():
    ...
    parser.add_argument('--num_nodes', '-nn', metavar='NN', type=int, default=1, help='number of nodes for training')
    parser.add_argument('--num_gpus_per_node', '-ngpn', metavar='NGPN', type=int, default=1, help='number of gpus per node for training')
